...
def _compute_depth_signal(state: DSAState) -> dict:
    ...
    # Require more specific give-up phrasing to avoid false positives on phrases
    # like "I'm not sure how to handle this" which indicate partial knowledge, not surrender.
    _stuck_phrases = (
        "i don't know", "i dont know", "i have no idea", "no idea", "i can't",
        "i cannot", "i'm blank", "im blank", "i'm stuck", "im stuck",
        "i give up", "i give in", "i'm giving up",
    )
